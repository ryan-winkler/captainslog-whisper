...
software according to [Distribution
...
> Required Notice: Copyright Ryan Winkler (https://ryanw.eu)
...
Use of the software for the benefit of your company is use
for a permitted purpose if your company has fewer than 100
total individuals working as employees and independent
contractors, and less than 1,000,000 USD (2019) total revenue
in the prior tax year. Adjust this revenue threshold for
inflation according to the United States Bureau of Labor
Statistics' consumer price index for all urban consumers,
U.S. city average, for all items, not seasonally adjusted,
...
Required Notice: Copyright (c) 2026 Ryan Winkler (https://ryanw.eu)

For commercial licensing (100+ employees or $1M+ revenue), contact: https://ryanw.eu